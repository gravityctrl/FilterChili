...
{
    public sealed class LessThanComparerTest
    {
        private readonly LessThanComparer<Product, int> _testInstance;

        public LessThanComparerTest()
        {
            _testInstance = new LessThanComparer<Product, int>(0);
        }

        [Fact]
        public void Should_Have_Correct_FilterType()
        {
            _testInstance.FilterType.Should().Be("LessThan");
        }
