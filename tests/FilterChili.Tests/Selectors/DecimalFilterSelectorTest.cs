...
namespace GravityCTRL.FilterChili.Tests.Selectors
{
    public sealed class DecimalFilterSelectorTest
    {
        ...
        public DecimalFilterSelectorTest()
        {
        ...
        public void Should_Return_Range_Resolver()
        {
            ...
            result.Should().BeOfType<RangeResolver<GenericSource, decimal>>();
        ...
        public void Should_Return_GreaterThan_Resolver()
        {
            ...
            result.Should().BeOfType<ComparisonResolver<GenericSource, decimal>>();
            result.Name.Should().Be(TEST_NAME);
