...
{
    public sealed class LongFilterSelectorTest
    {
        private const string TEST_NAME = "Long";

        private readonly LongFilterSelector<GenericSource> _testInstance;

        public LongFilterSelectorTest()
        {
            _testInstance = new LongFilterSelector<GenericSource>(p => p.Long);
        }
        ...
        public void Should_Return_Range_Resolver()
        {
            ...
            result.Should().BeOfType<RangeResolver<GenericSource, long>>();
        ...
        public void Should_Return_GreaterThan_Resolver()
        {
            ...
            result.Should().BeOfType<ComparisonResolver<GenericSource, long>>();
            result.Name.Should().Be(TEST_NAME);
