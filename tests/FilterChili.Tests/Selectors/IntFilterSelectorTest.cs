...
{
    public sealed class IntFilterSelectorTest
    {
        private const string TEST_NAME = "Int";
        ...
        public void Should_Return_Range_Resolver()
        {
            ...
            result.Should().BeOfType<RangeResolver<GenericSource, int>>();
        ...
        public void Should_Return_GreaterThan_Resolver()
        {
            ...
            result.Should().BeOfType<ComparisonResolver<GenericSource, int>>();
            result.Name.Should().Be(TEST_NAME);
