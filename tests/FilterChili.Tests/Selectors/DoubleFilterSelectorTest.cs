...
{
    public sealed class DoubleFilterSelectorTest
    {
        private const string TEST_NAME = "Double";
        ...
        public void Should_Return_Range_Resolver()
        {
            ...
            result.Should().BeOfType<RangeResolver<GenericSource, double>>();
        ...
        public void Should_Return_GreaterThan_Resolver()
        {
            ...
            result.Should().BeOfType<ComparisonResolver<GenericSource, double>>();
            result.Name.Should().Be(TEST_NAME);
