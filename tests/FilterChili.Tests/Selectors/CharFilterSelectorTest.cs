...
{
    public sealed class CharFilterSelectorTest
    {
        private const string TEST_NAME = "Char";
        ...
        public void Should_Return_Range_Resolver()
        {
            ...
            result.Should().BeOfType<RangeResolver<GenericSource, char>>();
        ...
        public void Should_Return_GreaterThan_Resolver()
        {
            ...
            result.Should().BeOfType<ComparisonResolver<GenericSource, char>>();
            result.Name.Should().Be(TEST_NAME);
