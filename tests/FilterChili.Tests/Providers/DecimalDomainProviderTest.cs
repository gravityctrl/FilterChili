...
{
    public class DecimalDomainProviderTest
    {
        ...
        public void Should_Return_Range_Resolver()
        {
            ...
            result.Should().BeOfType<DecimalRangeResolver<GenericSource>>();
        ...
        public void Should_Return_GreaterThan_Resolver()
        {
            ...
            result.Should().BeOfType<DecimalComparisonResolver<GenericSource>>();
            result.Name.Should().Be(TEST_NAME);
